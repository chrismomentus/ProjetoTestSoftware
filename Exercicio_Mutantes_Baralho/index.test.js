...
const listaDeInputs = [
  ...
  ["01C02C03C04C05C06C07C08C09C10C11C12C01E02E03E04E05E06E07E08E09E10E11E03U04U05U06U07U08U09U10U04P05P06P07P08P09P10P", [1,2,5,6], "CT4"],
  ["01C02C03C04C05C06C09E10E11E08U09U10U01P02P", [7,10,10,11], "CT5"], 
  ...
  ["04C05C06C07C08C10E11E12E13E01E07U08U09U10U11U02P03P04P", [8, 8, 8, 10], "CT7"], 
...
test.each(reorderList)('Should Run Baralho3 with test case %s and result in \"%s\"', (ctLabel, expectedResult, firstArg) => {
    expect(index.baralho3Correto(firstArg)).toStrictEqual(expectedResult);    
  });
